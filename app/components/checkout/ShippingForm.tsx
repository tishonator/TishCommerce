...
export default function ShippingForm() {
  ...
  useEffect(() => {
    // If country is not set, assign default from config
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input name="state" value={form.state} onChange={handleChange} placeholder={labels.state} className="input bg-white border border-gray-300 p-1 pl-2 rounded" />
